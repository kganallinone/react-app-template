...
export const BottomMobileNavigation = () => {
  return (
    <div className="fixed bottom-0 left-0 w-full flex justify-around rounded-t-3xl bg-white shadow-md p-5">
      <div>
        <Link to={"/home"} className="text-accent font-semibold icon-link">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div>
        <Link to={"/history"} className="text-accent font-semibold icon-link">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
      ...
      <div>
        <Link
          to={"/search"}
          className="text-accent font-semibold icon-stroke-link"
        >
          <svg
            width="24"
            height="24"
      ...
      <div>
        <Link to={"/account"} className="text-accent font-semibold icon-link">
          <svg
            width="24"
            height="24"
            viewBox="0 0 24 24"
